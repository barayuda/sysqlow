...
describe('database schema', () => {
	...
	test('defines pgvector migration support and important indexes', () => {
		...
		expect(migration).toContain('"dimensions" integer NOT NULL')
		expect(migration).toContain('embeddings_provider_model_dimensions_idx')
		expect(migration).toContain('embeddings_scope_chunk_provider_model_idx')
